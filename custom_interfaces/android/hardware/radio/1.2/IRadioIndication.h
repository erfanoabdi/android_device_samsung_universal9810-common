...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_2::IRadioIndication>& o) {
    std::string os = "[class or subclass of ";
    os += ::android::hardware::radio::V1_2::IRadioIndication::descriptor;
    os += "]";
